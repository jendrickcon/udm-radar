...
<div class="main-content">
    <div class="header">
        <div>
            <h1>Settings</h1>
            <p>Manage your account security and portal preferences.</p>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="settings.php">
                <div style="margin-bottom:16px;">
                    ...
                    <input type="password" name="current_password" required style="width:100%; padding:12px 14px; border:1px solid var(--border-color); border-radius:8px; background:var(--bg-color); color:var(--text-dark);">
                </div>
                <div style="margin-bottom:16px;">
                    <label style="display:block; font-weight:600; font-size:0.9rem; margin-bottom:6px; color:var(--text-dark);">New Password</label>
                    <input type="password" name="new_password" required minlength="8" style="width:100%; padding:12px 14px; border:1px solid var(--border-color); border-radius:8px; background:var(--bg-color); color:var(--text-dark);">
                </div>
                <div style="margin-bottom:20px;">
                    ...
                    <input type="password" name="confirm_password" required minlength="8" style="width:100%; padding:12px 14px; border:1px solid var(--border-color); border-radius:8px; background:var(--bg-color); color:var(--text-dark);">
                </div>
