  ...
  <ul class="sidebar-nav">
    ...
    <?php
        $svg = match($label) {
            ...
            'Feedback & Reports', 'Activity & Inbox' => '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>',
  ...
  <div class="sidebar-footer">
    ...
    <button onclick="toggleTheme()" class="theme-toggle-btn">
      <div class="theme-icon-wrapper">
          <svg id="sidebar-icon-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sidebar-icon">
              <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
          </svg>
          <svg id="sidebar-icon-sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sidebar-icon">
...
<script>
// Toggle Theme function + Dynamic Text Update
...
function updateToggleText(theme) {
    ...
    if(textEl) {
        textEl.innerText = theme === 'light' ? 'Dark Mode' : 'Light Mode';
    }
}
